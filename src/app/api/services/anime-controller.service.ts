...
export class AnimeControllerService extends BaseService {
   ...
   */
  static readonly SearchBooksPath = '/api/v1/anime/search';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, AnimeControllerService.SearchBooksPath, 'get');
    if (params) {
