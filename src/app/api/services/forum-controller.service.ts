...
export class ForumControllerService extends BaseService {
   ...
   */
  static readonly ObterPorIdPath = '/api/v1/forum/{id}';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, ForumControllerService.ObterPorIdPath, 'get');
    if (params) {
   ...
   */
  static readonly AlterarPath = '/api/v1/forum/{id}';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, ForumControllerService.AlterarPath, 'put');
    if (params) {
      rb.path('id', params.id, {});
   ...
   */
  static readonly RemoverPath = '/api/v1/forum/{id}';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, ForumControllerService.RemoverPath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }
   ...
   */
  static readonly ListAllPath = '/api/v1/forum';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, ForumControllerService.ListAllPath, 'get');
    if (params) {
    }
   ...
   */
  static readonly IncluirPath = '/api/v1/forum';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, ForumControllerService.IncluirPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
   ...
   */
  static readonly GetDadosPath = '/api/v1/forum/data';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, ForumControllerService.GetDadosPath, 'get');
    if (params) {
